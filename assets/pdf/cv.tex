...
\usepackage[letterpaper,top=0.5in,bottom=0.35in,left=0.7in,right=0.7in]{geometry}
\usepackage{enumitem}
...
\newcommand{\award}[2]{\rline{#1}{#2}\vspace{1.2pt}}
...
\vfill
\begin{center}
  {\small Last updated: August 30, 2026}
\end{center}
