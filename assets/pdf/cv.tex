...
\begin{center}
  ...
  \vspace{6pt}
  Email: \href{mailto:johnbie0627@gmail.com}{johnbie0627@gmail.com}\qquad
  Website: \href{https://birmjune.github.io}{birmjune.github.io}\qquad
  GitHub: \href{https://github.com/Birmjune}{github.com/Birmjune}
\end{center}
...
\begin{resbody}
  \begin{points}[itemsep=5pt]
    \item \textbf{Efficient AI.} Making efficient AI models across various levels of the
      stack: inference-time methods, model compression and quantization, AI compilers,
...
\heading{Projects}
\begin{resbody}
  \entry{\href{https://github.com/Birmjune/SNU_AI_Challenge_2026_DeepRed}{SNU AI Challenge 2026: Storyline Frame Ordering}}{Jul 2026 - Aug 2026}
  \begin{points}
    ...
    \item One of 12 finalist teams out of 206.
  \end{points}

  \entrygap
  \entry{\href{https://github.com/Birmjune/swpp202601-team15}{LLVM Optimization for a Custom Target Machine}}{May 2026 - Jun 2026}
  \begin{points}
    \item An LLVM IR optimization pipeline for a custom target machine, with custom arithmetic,
      memory, and loop passes ahead of a provided backend.
    \item 6th of 24 teams in the course competition.
  \end{points}
  \entrygap
  ...
  \entrygap
  \entry{\href{https://github.com/CSEneversleep/cns-next}{Afterglow: Event Photo Collection and Highlight Video}}{May 2025}
  \begin{points}
    \item Collects event photos through a QR code and replays them as a highlight video.
    \item Built with a four-person team at the 3rd SKYST Joint Hackathon;
      Entrepreneur Award (1st in business idea).
  \end{points}

  \entrygap
  \entry{\href{https://github.com/Birmjune/Easy-ARC-AGI-solver}{Easy ARC-AGI Challenge Solver}}{Apr 2025 - Jun 2025}
  \begin{points}
  ...
  \end{points}
  \entrygap
  \entry{\href{https://github.com/Birmjune/RISC-V_BluespecVerilog}{RISC-V CPU in Bluespec}}{Mar 2025 - Jun 2025}
  \begin{points}
    \item RISC-V processors in Bluespec SystemVerilog, from a four-cycle non-pipelined CPU to
      three- and five-stage pipelines and a cached three-stage design.
    \item Control hazards handled with epochs; data hazards with a scoreboard and with forwarding.
  \end{points}
\end{resbody}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Honors and awards %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Two pages since Sep 2026. Break here so Honors and Skills stay together on
% page 2 instead of Honors splitting across the fold.
\pagebreak
\heading{Honors and Awards}
\begin{resbody}
  \award{One of 23 finalist teams (1,603 teams), NEXON Young Programmers Cup (NYPC) 2026, Master track}{2026}
  \award{One of 12 finalist teams (206 teams), SNU AI Challenge 2026}{2026}
...
\vfill
\begin{center}
  {\small Last updated: September 10, 2026}
\end{center}
